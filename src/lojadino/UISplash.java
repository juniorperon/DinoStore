...
public class UISplash extends javax.swing.JFrame {
         ...
         public void run(){
             ...
             for (int i = 0; i < 101; i++) {
                 try {
                     ...
                     if (i == 100) {
                         CadastroClientes login = new CadastroClientes (); // Orientação a objeto, chama a janela de SPLASH após entrar no IF
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lojadino/logo_facens.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 511, Short.MAX_VALUE)
